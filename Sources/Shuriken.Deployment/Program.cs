...
using Shuriken.Deployment.Properties;

namespace Shuriken.Deployment
{
    internal static class Program
    {
            ...
            [NotNull] out string nuspecAnnotationsPath)
        {
            ...
            assemblyPath = Path.Combine(solutionDirectory, @"Shuriken.Wpf", "bin", executionDirectory, @"Shuriken.Wpf.dll");

            nuspecPath = Path.Combine(executionDirectoryPath, "Shuriken.nuspec");

            nuspecAnnotationsPath = Path.Combine(executionDirectoryPath, "Shuriken.Annotations.nuspec");
        }
